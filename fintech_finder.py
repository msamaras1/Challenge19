...
#The crypto_wallet.py file is located in the same location as the fintech_finder.py file has several functions that being imported
...
candidate_database = {
    "Lane": ["Lane", "0xA67187A20ebefE8a8C1F74872f7F313AA4F1320f", "4.3", .20, "Images/lane.jpeg"],
    "Ash": ["Ash", "0x71D19FF7d06B44f39e5f5beE1777C7A1eab222ad", "5.0", .33, "Images/ash.jpeg"],
    "Jo": ["Jo", "0xaD493753EFEA1eA1a5424E220B0356732dCfbfD3", "4.7", .19, "Images/jo.jpeg"],
    "Kendall": ["Kendall", "0xea4115101b7d352D90fE5Ec21f2c6Ab16012ffeA", "4.1", .16, "Images/kendall.jpeg"]
}
...
# YOUR CODE HERE
wage=hourly_rate*hours #candidate_database[person][candidate]*hours
# @TODO
